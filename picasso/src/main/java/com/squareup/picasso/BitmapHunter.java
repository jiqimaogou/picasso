...
abstract class BitmapHunter implements Runnable {
  ...
  public static BitmapHunterProvider sBitmapHunterProvider = new DefaultBitmapHunterProvider();
  ...
  static BitmapHunter forRequest(Context context, Picasso picasso, Dispatcher dispatcher,
    ...
    return sBitmapHunterProvider.getBitmapHunter(context, picasso, dispatcher, cache, stats, action,
        downloader);
  }

  public static class DefaultBitmapHunterProvider implements BitmapHunterProvider {

    @Override public BitmapHunter getBitmapHunter(Context context, Picasso picasso,
        Dispatcher dispatcher, Cache cache, Stats stats, Action action, Downloader downloader) {
  ...
  public interface BitmapHunterProvider {

    BitmapHunter getBitmapHunter(Context context, Picasso picasso, Dispatcher dispatcher,
        Cache cache, Stats stats, Action action, Downloader downloader);
  }
  /**
